...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.getUserById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.getUserByIdRepository(id)];
                    case 1:
                        user = _a.sent();
                        if (!user)
    ...
    // ✅ Actualizar usuario
    UsersService.prototype.updateUser = function (id, updateUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, this.usersRepository.putUpdateUserRepository(user, updateUserDto)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, this.usersRepository.deleteUserRepository(user)];
                }
            });
        });
    };
    ...
    // ✅ Buscar por teléfono
    UsersService.prototype.getUserByPhone = function (phone) {
        return this.usersRepository.getByUserPhone(Number(phone));
    };
    // ✅ Perfil
    UsersService.prototype.getUserProfile = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, this.usersRepository.getUserProfileRepository(user)];
                }
            });
        });
    };
