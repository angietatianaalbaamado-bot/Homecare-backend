...
var CredentialRepository = /** @class */ (function () {
    function CredentialRepository(credentialDataBase) {
        this.credentialDataBase = credentialDataBase;
    }
    //metodo para obtener un usuario por su username
    CredentialRepository.prototype.getCredentialByUsername = function (username) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.credentialDataBase.findOne({
